...
class Results(SimpleClass):
    ...
    def __init__(
        self, orig_img, path, names, boxes=None, masks=None, probs=None, keypoints=None, obb=None, speed=None, full_preds=None
    ) -> None:
        """
    ...
    def full_summary(self): # New function for full summary 
        ...
        for full_pred in full_preds:
            x1, y1, x2, y2 = full_pred[:4].tolist()
            
            probabilities = full_pred[4:].tolist()
            
            predictions = {class_names[i]: prob for i, prob in enumerate(probabilities)}
